...
# print(df[["Name", "Marks", "City"]])  # selecting multiple columns

# print(df.loc[0])  # accessing by index label]

# print(df.iloc[1])    

print(df.loc[0, "Marks"])  # accessing by index label and column
print(df.iloc[0, 2])  # accessing by position